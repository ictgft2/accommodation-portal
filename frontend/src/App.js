      ...
      <Router>
        <AuthProvider>
          ...
          <Route
            path="/dashboard"
            element={
              <ProtectedRoute requiredRoles={['SuperAdmin', 'PortalManager', 'Deacon', 'Pastor', 'Member']}>
                <DashboardPage />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredRoles={['PortalManager']}>
                <DashboardPage />
              </ProtectedRoute>
            }
          />
          <Route
            path="/portal-manager/bookings"
            element={
              <ProtectedRoute requiredRoles={['PortalManager']}>
                <AllocationManagementPage />
              </ProtectedRoute>
          ...
          {/* Deacon Routes (formerly Service Unit Admin) */}
          <Route
            path="/deacon/dashboard"
            element={
              <ProtectedRoute requiredRoles={['Deacon']}>
                <DashboardPage />
              </ProtectedRoute>
            }
          />
          ...
          <Route path="/portal-manager" element={<Navigate to="/portal-manager/dashboard" replace />} />
          <Route path="/deacon" element={<Navigate to="/deacon/dashboard" replace />} />
          <Route path="/pastor" element={<Navigate to="/dashboard" replace />} />
          <Route path="/member" element={<Navigate to="/dashboard" replace />} />

          {/* Legacy redirect for old service-unit routes */}
          <Route path="/service-unit" element={<Navigate to="/deacon/dashboard" replace />} />
          <Route path="/service-unit/dashboard" element={<Navigate to="/deacon/dashboard" replace />} />
          <Route path="/service-unit/members" element={<Navigate to="/deacon/members" replace />} />
          <Route path="/service-unit/allocations" element={<Navigate to="/deacon/allocations" replace />} />
