...
const AdminLayout = ({ children, title }) => {
  ...
  const getNavigationItems = () => {
    const baseItems = [
      { name: 'Dashboard', icon: Home, path: '/dashboard', roles: ['SuperAdmin', 'PortalManager', 'Deacon', 'Pastor', 'Member'] },
    ];
    ...
    } else if (user?.role === 'PortalManager') {
      roleSpecificItems.push(
        { name: 'Manage Bookings', icon: Calendar, path: '/portal-manager/bookings', roles: ['PortalManager'] },
        { name: 'Financial Reports', icon: BarChart3, path: '/portal-manager/reports', roles: ['PortalManager'] },
        { name: 'Announcements', icon: Bell, path: '/portal-manager/announcements', roles: ['PortalManager'] },
      );
    } else if (user?.role === 'Deacon') {
      roleSpecificItems.push(
        { name: 'My Service Unit', icon: UserCheck, path: '/deacon/dashboard', roles: ['Deacon'] },
        { name: 'Members', icon: Users, path: '/deacon/members', roles: ['Deacon'] },
        { name: 'Allocations', icon: Calendar, path: '/deacon/allocations', roles: ['Deacon'] },
        { name: 'Unit Reports', icon: BarChart3, path: '/deacon/reports', roles: ['Deacon'] },
      );
