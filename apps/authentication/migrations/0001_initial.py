    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SuperAdmin', 'Super Admin'), ('ServiceUnitAdmin', 'Service Unit Admin'), ('Pastor', 'Pastor'), ('Member', 'Member')], default='Member', help_text='User role in the system', max_length=30)),
